...
begin
  ...
  begin
    ...
    MainForm.StringGrid_Targets.Columns.Items[0].Width :=
      Scale96ToForm(FINI.ReadInteger('SG', '0', 80));
    MainForm.StringGrid_Targets.Columns.Items[1].Width :=
      Scale96ToForm(FINI.ReadInteger('SG', '1', 150));
    MainForm.StringGrid_Targets.Columns.Items[2].Width :=
      Scale96ToForm(FINI.ReadInteger('SG', '2', 100));
    MainForm.StringGrid_Targets.Columns.Items[3].Width :=
      Scale96ToForm(FINI.ReadInteger('SG', '3', 130));
    MainForm.StringGrid_Targets.Columns.Items[4].Width :=
      Scale96ToForm(FINI.ReadInteger('SG', '4', 170));
    MainForm.StringGrid_Targets.Columns.Items[5].Width :=
      Scale96ToForm(FINI.ReadInteger('SG', '5', 100));
...
begin
  ...
  begin
    ...
    if (MainForm.WindowState = wsNormal) then
      //nicht speichern, wenn maximiert, minimiert
    begin
    ...
    //Größe der Spalten des StringGrid
    FINI.WriteInteger('SG', '0',
      ScaleFormTo96(MainForm.StringGrid_Targets.Columns.Items[0].Width));
    FINI.WriteInteger('SG', '1',
      ScaleFormTo96(MainForm.StringGrid_Targets.Columns.Items[1].Width));
    FINI.WriteInteger('SG', '2',
      ScaleFormTo96(MainForm.StringGrid_Targets.Columns.Items[2].Width));
    FINI.WriteInteger('SG', '3',
      ScaleFormTo96(MainForm.StringGrid_Targets.Columns.Items[3].Width));
    FINI.WriteInteger('SG', '4',
      ScaleFormTo96(MainForm.StringGrid_Targets.Columns.Items[4].Width));
    FINI.WriteInteger('SG', '5',
      ScaleFormTo96(MainForm.StringGrid_Targets.Columns.Items[5].Width));
